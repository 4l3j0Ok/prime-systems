...
IF NOT EXISTS (
    SELECT *
    FROM INFORMATION_SCHEMA.TABLES
    WHERE TABLE_NAME = 'Usuarios_Tipo'
        AND TABLE_SCHEMA = 'dbo'
) BEGIN
...
IF NOT EXISTS (
    SELECT *
    FROM INFORMATION_SCHEMA.TABLES
    WHERE TABLE_NAME = 'H_Movimientos'
        AND TABLE_SCHEMA = 'dbo'
) BEGIN
...
IF NOT EXISTS (
    SELECT *
    FROM INFORMATION_SCHEMA.TABLES
    WHERE TABLE_NAME = 'In_Out_Varios'
        AND TABLE_SCHEMA = 'dbo'
) BEGIN
...
IF NOT EXISTS (
    SELECT *
    FROM INFORMATION_SCHEMA.TABLES
    WHERE TABLE_NAME = 'H_Compras_Detalle'
        AND TABLE_SCHEMA = 'dbo'
) BEGIN
...
IF NOT EXISTS (
    SELECT *
    FROM INFORMATION_SCHEMA.TABLES
    WHERE TABLE_NAME = 'H_Ventas_Detalle'
        AND TABLE_SCHEMA = 'dbo'
) BEGIN
